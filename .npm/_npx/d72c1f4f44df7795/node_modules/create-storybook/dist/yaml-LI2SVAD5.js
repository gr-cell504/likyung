...
`),n}xs.parse=Io;}),qe=te(k=>{var p=le();function Po(t,e,n){return n?`#${n.replace(/[\s\S]^/gm,`$&${e}#`)}
...
`)+`
`}};Y._defineProperty(Zt,"defaults",pi),en.Document=Zt,en.defaultOptions=Ca,en.scalarOptions=Ma;}),di=te(gi=>{var Zn=Rs(),Oe=mi(),Da=Xn(),Ya=le(),$a=Qn();qe();function Ba(t,e=!0,n){n===void 0&&typeof e=="string"&&(n=e,e=!0);let r=Object.assign({},Oe.Document.defaults[Oe.defaultOptions.version],Oe.defaultOptions);return new Da.Schema(r).createNode(t,e,n)}var We=class extends Oe.Document{constructor(e){super(Object.assign({},Oe.defaultOptions,e));}};function Fa(t,e){let n=[],r;for(let s of Zn.parse(t)){let i=new We(e);i.parse(s,r),n.push(i),r=i;}return n}function hi(t,e){let n=Zn.parse(t),r=new We(e).parse(n[0]);if(n.length>1){let s="Source contains multiple documents; please use YAML.parseAllDocuments()";r.errors.unshift(new Ya.YAMLSemanticError(n[1],s));}return r}function qa(t,e){let n=hi(t,e);if(n.warnings.forEach(r=>$a.warn(r)),n.errors.length>0)throw n.errors[0];return n.toJSON()}function Ua(t,e){let n=new We(e);return n.contents=t,String(n)}var Ka={createNode:Ba,defaultOptions:Oe.defaultOptions,Document:We,parse:qa,parseAllDocuments:Fa,parseCST:Zn.parse,parseDocument:hi,scalarOptions:Oe.scalarOptions,stringify:Ua};gi.YAML=Ka;}),Ei=te((qm,yi)=>{yi.exports=di().YAML;}),Si=te(J=>{var je=qe(),Qe=le();J.findPair=je.findPair,J.parseMap=je.resolveMap,J.parseSeq=je.resolveSeq,J.stringifyNumber=je.stringifyNumber,J.stringifyString=je.stringifyString,J.toJSON=je.toJSON,J.Type=Qe.Type,J.YAMLError=Qe.YAMLError,J.YAMLReferenceError=Qe.YAMLReferenceError,J.YAMLSemanticError=Qe.YAMLSemanticError,J.YAMLSyntaxError=Qe.YAMLSyntaxError,J.YAMLWarning=Qe.YAMLWarning;}),nr={};rr(nr,{languages:()=>_r,options:()=>xr,parsers:()=>tr,printers:()=>Ha});var Pi=(t,e,n,r)=>{if(!(t&&e==null))return e.replaceAll?e.replaceAll(n,r):n.global?e.replace(n,r):e.split(n).join(r)},yt=Pi,Le="string",Je="array",Ge="cursor",He="indent",Ae="align",Xe="trim",Te="group",Ce="fill",he="if-break",ze="indent-if-break",Me="line-suffix",Ze="line-suffix-boundary",Z="line",et="label",ke="break-parent",Et=new Set([Ge,He,Ae,Xe,Te,Ce,he,ze,Me,Ze,Z,et,ke]),_i=(t,e,n)=>{if(!(t&&e==null))return Array.isArray(e)||typeof e=="string"?e[n<0?e.length+n:n]:e.at(n)},x=_i;function xi(t){if(typeof t=="string")return Le;if(Array.isArray(t))return Je;if(!t)return;let{type:e}=t;if(Et.has(e))return e}var ve=xi,Ri=t=>new Intl.ListFormat("en-US",{type:"disjunction"}).format(t);function Di(t){let e=t===null?"null":typeof t;if(e!=="string"&&e!=="object")return `Unexpected doc '${e}', 
