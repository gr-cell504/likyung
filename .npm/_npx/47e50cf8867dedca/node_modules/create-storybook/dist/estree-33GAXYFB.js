...
Expected it to be ${n}.`}var Wn=class extends Error{name="InvalidDocError";constructor(t){super(Oo(t)),this.doc=t;}},dt=Wn,hu={};function _o(e,t,r,n){let s=[e];for(;s.length>0;){let u=s.pop();if(u===hu){r(s.pop());continue}r&&s.push(u,hu);let i=Se(u);if(!i)throw new dt(u);if(t?.(u)!==!1)switch(i){case he:case Oe:{let a=i===he?u:u.parts;for(let o=a.length,p=o-1;p>=0;--p)s.push(a[p]);break}case Te:s.push(u.flatContents,u.breakContents);break;case me:if(n&&u.expandedStates)for(let a=u.expandedStates.length,o=a-1;o>=0;--o)s.push(u.expandedStates[o]);else s.push(u.contents);break;case $e:case Ve:case Qe:case ge:case ze:s.push(u.contents);break;case qe:case st:case Ke:case We:case ie:case _e:break;default:throw new dt(u)}}}var pr=_o;function yt(e,t){if(typeof e=="string")return t(e);let r=new Map;return n(e);function n(u){if(r.has(u))return r.get(u);let i=s(u);return r.set(u,i),i}function s(u){switch(Se(u)){case he:return t(u.map(n));case Oe:return t({...u,parts:u.parts.map(n)});case Te:return t({...u,breakContents:n(u.breakContents),flatContents:n(u.flatContents)});case me:{let{expandedStates:i,contents:a}=u;return i?(i=i.map(n),a=i[0]):a=n(a),t({...u,contents:a,expandedStates:i})}case $e:case Ve:case Qe:case ge:case ze:return t({...u,contents:n(u.contents)});case qe:case st:case Ke:case We:case ie:case _e:return t(u);default:throw new dt(u)}}}function Su(e,t,r){let n=r,s=!1;function u(i){if(s)return !1;let a=t(i);a!==void 0&&(s=!0,n=a);}return pr(e,u),n}function vo(e){if(e.type===me&&e.break||e.type===ie&&e.hard||e.type===_e)return !0}function re(e){return Su(e,vo,!1)}function gu(e){if(e.length>0){let t=M(!1,e,-1);!t.expandedStates&&!t.break&&(t.break="propagated");}return null}function Bu(e){let t=new Set,r=[];function n(u){if(u.type===_e&&gu(r),u.type===me){if(r.push(u),t.has(u))return !1;t.add(u);}}function s(u){u.type===me&&r.pop().break&&gu(r);}pr(e,n,s,!0);}function jo(e){return e.type===ie&&!e.hard?e.soft?"":" ":e.type===Te?e.flatContents:e}function cr(e){return yt(e,jo)}function Mo(e){switch(Se(e)){case Oe:if(e.parts.every(t=>t===""))return "";break;case me:if(!e.contents&&!e.id&&!e.break&&!e.expandedStates)return "";if(e.contents.type===me&&e.contents.id===e.id&&e.contents.break===e.break&&e.contents.expandedStates===e.expandedStates)return e.contents;break;case $e:case Ve:case Qe:case ze:if(!e.contents)return "";break;case Te:if(!e.flatContents&&!e.breakContents)return "";break;case he:{let t=[];for(let r of e){if(!r)continue;let[n,...s]=Array.isArray(r)?r:[r];typeof n=="string"&&typeof M(!1,t,-1)=="string"?t[t.length-1]+=n:t.push(n),t.push(...s);}return t.length===0?"":t.length===1?t[0]:t}case qe:case st:case Ke:case We:case ie:case ge:case _e:break;default:throw new dt(e)}return e}function Ut(e){return yt(e,t=>Mo(t))}function ve(e,t=Rr){return yt(e,r=>typeof r=="string"?b(t,r.split(`
`)):r)}function Ro(e){if(e.type===ie)return !0}function bu(e){return Su(e,Ro,!1)}function lr(e,t){return e.type===ge?{...e,contents:t(e.contents)}:t(e)}function Pu(e){let t=!0;return pr(e,r=>{switch(Se(r)){case qe:if(r==="")break;case Ke:case We:case ie:case _e:return t=!1,!1}}),t}var Nn=()=>{},Gn=Nn;function f(e){return {type:Ve,contents:e}}function Be(e,t){return {type:$e,contents:t,n:e}}function l(e,t={}){return Gn(t.expandedStates),{type:me,id:t.id,contents:e,break:!!t.shouldBreak,expandedStates:t.expandedStates}}function Iu(e){return Be(Number.NEGATIVE_INFINITY,e)}function Jr(e){return Be(-1,e)}function et(e,t){return l(e[0],{...t,expandedStates:e})}function qr(e){return {type:Oe,parts:e}}function B(e,t="",r={}){return {type:Te,breakContents:e,flatContents:t,groupId:r.groupId}}function xt(e,t){return {type:Qe,contents:e,groupId:t.groupId,negate:t.negate}}function Un(e){return {type:ze,contents:e}}var je={type:We},Ee={type:_e},Yn={type:ie,hard:!0},Jo={type:ie,hard:!0,literal:!0},x={type:ie},E={type:ie,soft:!0},F=[Yn,Ee],Rr=[Jo,Ee],mr={type:st};function b(e,t){let r=[];for(let n=0;n<t.length;n++)n!==0&&r.push(e),r.push(t[n]);return r}function Lu(e,t,r){let n=e;if(t>0){for(let s=0;s<Math.floor(t/r);++s)n=f(n);n=Be(t%r,n),n=Be(Number.NEGATIVE_INFINITY,n);}return n}function ut(e,t){return e?{type:ge,label:e,contents:t}:t}function qo(e){let t=`*${e.value}*`.split(`
